...
<title>Information Sheet Not Accepted - PUP TBIDO</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px; background-color:#ffffff; border-radius:16px; overflow:hidden; border:1px solid #e5e7eb;">
                    ...
                    <tr>
                        <td style="padding: 0 32px 32px 32px; text-align:left;">
                            <h1 style="margin:0 0 16px 0; font-size:22px; color:#111827; text-align:center;">Information Sheet Not Accepted</h1>
                            <p style="margin:0 0 16px 0; font-size:14px; line-height:22px; color:#4b5563;">
                                Dear {{ $founderName }},
                            </p>
                            <p style="margin:0 0 16px 0; font-size:14px; line-height:22px; color:#4b5563;">
                                Your Information Sheet (PUP-TBIDO Form No. 001) for <strong>{{ $companyName }}</strong>
                                was not accepted during this evaluation. You may revise and resubmit it.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fdf2f4; border-radius:8px; margin: 0 0 16px 0;">
                                <tr>
                                    <td style="padding: 14px 16px;">
                                        <p style="margin:0 0 4px 0; font-size:13px; font-weight:700; color:#6D0D23;">Evaluator Remarks</p>
                                        <p style="margin:0; font-size:14px; line-height:20px; color:#4b5563;">{{ $remarks }}</p>
                                    </td>
                                </tr>
                            </table>
                            @endif
                            ...
                            @if ($deadline)
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fffbeb; border-radius:8px; margin: 0 0 16px 0;">
                                <tr>
                                    <td style="padding: 14px 16px;">
                                        <p style="margin:0 0 4px 0; font-size:13px; font-weight:700; color:#92400e;">Resubmission Deadline</p>
                                        <p style="margin:0; font-size:14px; line-height:20px; color:#4b5563;">
                                            Please revise and resubmit your Information Sheet by
                                            <strong>{{ $deadline->format('F j, Y') }}</strong>. Accounts not
                                            resubmitted by this date are automatically removed from the program.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin:0 0 24px 0; font-size:14px; line-height:22px; color:#4b5563;">
                                Log in to your account to review the remarks and update your Information Sheet.
                            </p>
