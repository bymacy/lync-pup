...
<title>Startup Account Removed - PUP TBIDO</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px; background-color:#ffffff; border-radius:16px; overflow:hidden; border:1px solid #e5e7eb;">
                    ...
                    <tr>
                        <td style="padding: 0 32px 32px 32px; text-align:left;">
                            <h1 style="margin:0 0 16px 0; font-size:22px; color:#111827; text-align:center;">Startup Account Removed</h1>
                            <p style="margin:0 0 16px 0; font-size:14px; line-height:22px; color:#4b5563;">
                                Dear {{ $founderName }},
                            </p>
                            <p style="margin:0 0 16px 0; font-size:14px; line-height:22px; color:#4b5563;">
                                Your startup account, <strong>{{ $companyName }}</strong>, in the PUP TBIDO Startup
                                Incubation Program has been automatically removed. Your Information Sheet was
                                rejected on <strong>{{ $rejectedOn }}</strong>, and no revised submission was
                                received before the 10-day resubmission window ended on <strong>{{ $deadline }}</strong>.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 14px 16px;">
                                        <p style="margin:0; font-size:13px; line-height:20px; color:#4b5563;">
                                            This removal was performed automatically by the system, not by an
                                            administrator, once the resubmission deadline passed.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            <p style="margin:0 0 24px 0; font-size:14px; line-height:22px; color:#4b5563;">
                                If you believe this was in error, or would like to re-apply to the program, please
