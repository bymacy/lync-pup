...
>
    ...
    <div class="p-6">
        ...
        <div class="flex gap-3 pt-6">
            <button type="button" @click="{{ $close }}" class="flex-1 border rounded-lg py-2.5 text-sm font-medium">
            ...
            @if (! $isReadOnly)
                <button type="submit" form="{{ $formId }}"
                    class="flex-1 bg-gradient-to-r from-rose-900 to-blue-950 text-white rounded-lg py-2.5 text-sm font-medium">
                    @if ($mode === 'add')
                        Save Schedule
                    @elseif ($mode === 'edit')
                        Save Changes
